...
ApplicationInit(EResetReason_t eResetReason)
{
  ...
  DPRINT("\n\n--------------------------------\n");
  DPRINT("Z-Wave Sample App: KNX_8PB_SWITCH_NEW \n");
         ...
         if(APP_EVENT_SW1_DOWN == (APP_BUTTON_EVENT)event)
          {
            ...
            handle_switch_event(1);
               ...
               if(APP_EVENT_SW1_UP == (APP_BUTTON_EVENT)event)
                         {
                            DPRINT("EVENT_APP_DIMMER_RELEASE_1\n");
                            set_proximity_level();
                            Set_Relay(1, 1);
                         }
          ...
          if(APP_EVENT_SW2_DOWN == (APP_BUTTON_EVENT)event)
          {
           ...
           if(APP_EVENT_SW2_UP == (APP_BUTTON_EVENT)event)
                      {
                         DPRINT("EVENT_APP_DIMMER_RELEASE_2\n");
                         set_proximity_level();
                          Set_Relay(2, 1);
          ...
          if(APP_EVENT_SW3_UP == (APP_BUTTON_EVENT)event)
                     {
                        DPRINT("EVENT_APP_DIMMER_RELEASE_3\n");
                        set_proximity_level();
                         Set_Relay(3, 1);
          ...
          if(APP_EVENT_SW4_UP == (APP_BUTTON_EVENT)event)
                     {
                        DPRINT("EVENT_APP_DIMMER_RELEASE_4\n");
                        set_proximity_level();
                         Set_Relay(4, 1);
          ...
          if(APP_EVENT_SW5_UP == (APP_BUTTON_EVENT)event)
                     {
                        DPRINT("EVENT_APP_DIMMER_RELEASE_5\n");
                        set_proximity_level();
                         Set_Relay(5, 1);
          ...
          if(APP_EVENT_SW6_UP == (APP_BUTTON_EVENT)event)
                     {
                        DPRINT("EVENT_APP_DIMMER_RELEASE_6\n");
                        set_proximity_level();
                         Set_Relay(6, 1);
                      }
          ...
          if(APP_EVENT_SW7_UP == (APP_BUTTON_EVENT)event)
            {
               DPRINT("EVENT_APP_DIMMER_RELEASE_7\n");
          ...
          if(APP_EVENT_SW8_UP == (APP_BUTTON_EVENT)event)
                     {
                        DPRINT("EVENT_APP_DIMMER_RELEASE_8\n");
                        set_proximity_level();
                        Set_Relay(8, 1);
...
void App_rx_Button_Timer_CB()
{
   if( (Current_Button_rx >= 1 && Current_Button_rx <= 8))
  {

       DPRINTF("Button %d pressed  .\n", Current_Button_rx);
       switch(Current_Button_rx)
       {
         case 1: ZAF_EventHelperEventEnqueueFromISR(APP_EVENT_SW1_UP); break;
         case 2: ZAF_EventHelperEventEnqueueFromISR(APP_EVENT_SW2_UP); break;
         case 3: ZAF_EventHelperEventEnqueueFromISR(APP_EVENT_SW3_UP); break;
         case 4: ZAF_EventHelperEventEnqueueFromISR(APP_EVENT_SW4_UP); break;
         case 5: ZAF_EventHelperEventEnqueueFromISR(APP_EVENT_SW5_UP); break;
         case 6: ZAF_EventHelperEventEnqueueFromISR(APP_EVENT_SW6_UP); break;
         case 7: ZAF_EventHelperEventEnqueueFromISR(APP_EVENT_SW7_UP); break;
         case 8: ZAF_EventHelperEventEnqueueFromISR(APP_EVENT_SW8_UP); break;
       }
   }
...
SetDefaultConfiguration(void)
{
 ...
 // appBinarySwitchSet(CMD_CLASS_BIN_OFF, 0, 0);
  DPRINT("---default---");
       ...
       ApplicationData.source_main_num = 1;

       ApplicationData.source_main_val = 1;
 //      DPRINTF("parameterNumber : %d, \n",parameterNumber);



  //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
       ApplicationData.source_mid_num = 2;

      ApplicationData.source_mid_val = 5;

  //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
       ApplicationData.source_sub_num =3;

       ApplicationData.source_sub_val = 8;
 //      DPRINTF("ApplicationData: %d\n",ApplicationData.source_sub_val);


  //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
       ApplicationData.dest_main_num_1 =4;

       ApplicationData.dest_main_val_1 =0;
 //     DPRINTF("ApplicationData: %d\n",ApplicationData.dest_main_val);


  //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
       ApplicationData.dest_mid_num_1 =5;

       ApplicationData.dest_mid_val_1 = 0;

  //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
       ApplicationData.dest_sub_num_1 =6;

       ApplicationData.dest_sub_val_1 = 1;

  //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
       ApplicationData.dest_main_num_2 =7;

       ApplicationData.dest_main_val_2 = 0;
 //     DPRINTF("ApplicationData: %d\n",ApplicationData.dest_main_val);


  //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
       ApplicationData.dest_mid_num_2 =8;

       ApplicationData.dest_mid_val_2 = 0;

  //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
       ApplicationData.dest_sub_num_2 =9;

       ApplicationData.dest_sub_val_2 = 2;

  //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
       ApplicationData.dest_main_num_3 =10;

       ApplicationData.dest_main_val_3 = 0;
 //     DPRINTF("ApplicationData: %d\n",ApplicationData.dest_main_val);


  //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
       ApplicationData.dest_mid_num_3 =11;

       ApplicationData.dest_mid_val_3 = 0;

  //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
       ApplicationData.dest_sub_num_3 =12;

       ApplicationData.dest_sub_val_3 = 3;



   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_main_num_4 =13;

        ApplicationData.dest_main_val_4 = 0;
  //     DPRINTF("ApplicationData: %d\n",ApplicationData.dest_main_val);


   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_mid_num_4 =14;

        ApplicationData.dest_mid_val_4 = 0;

   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_sub_num_4 =15;

        ApplicationData.dest_sub_val_4 = 4;

   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_main_num_5 =16;

        ApplicationData.dest_main_val_5 = 0;
  //     DPRINTF("ApplicationData: %d\n",ApplicationData.dest_main_val);


   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_mid_num_5 =17;

        ApplicationData.dest_mid_val_5 = 0;

   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_sub_num_5 =18;

        ApplicationData.dest_sub_val_5 = 5;

   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_main_num_6 = 19 ;

        ApplicationData.dest_main_val_6 = 0;
  //     DPRINTF("ApplicationData: %d\n",ApplicationData.dest_main_val);


   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_mid_num_6 =20;

        ApplicationData.dest_mid_val_6 = 0;

   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_sub_num_6 =21;

        ApplicationData.dest_sub_val_6 = 6;

        ApplicationData.dest_main_num_7 = 22 ;

        ApplicationData.dest_main_val_7 = 0;
  //     DPRINTF("ApplicationData: %d\n",ApplicationData.dest_main_val);


   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_mid_num_7 =23;

        ApplicationData.dest_mid_val_7 = 0;

   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_sub_num_7 =24;

        ApplicationData.dest_sub_val_7 = 7;

        ApplicationData.dest_main_num_8 = 25 ;

        ApplicationData.dest_main_val_8 = 0;
  //     DPRINTF("ApplicationData: %d\n",ApplicationData.dest_main_val);


   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_mid_num_8 =26;

        ApplicationData.dest_mid_val_8 = 0;

   //      DPRINTF("parameterNumber : %d, \n",parameterNumber);
        ApplicationData.dest_sub_num_8 =27;

        ApplicationData.dest_sub_val_8 = 8;
